...
riscv64-unknown-elf-gcc -c -mabi=ilp32 -march=rv32i -o load.o load.s

riscv64-unknown-elf-gcc -c -mabi=ilp32 -march=rv32i -o Firmware/syscalls.o Firmware/syscalls.c
riscv64-unknown-elf-gcc -mabi=ilp32 -march=rv32i -Wl,--gc-sections -o firmware.elf load.o sum1ton_abi.o Firmware/syscalls.o -T Firmware/riscv.ld -lstdc++
